...
public class Divide extends ParenExpression {
	...
	public Divide(String command, List<Expression> expressions) {
	...
	public ParenExpression createCorrectExpression(String command,
		...
		return new Divide(command, expressions);
	}

	public static ExpressionFactory getFactory() {
		return new ExpressionFactory(new Divide());
	}
	...
	public RGBColor evaluate(Map<String, Expression> map) {
		...
		return divide(left.evaluate(map), right.evaluate(map));
	}
